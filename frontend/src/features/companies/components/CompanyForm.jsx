...
export default function CompanyForm({ onSubmit }) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mb-3">
        <label htmlFor="company-manager" className="form-label">
          Manager
        </label>
        <input
          id="company-manager"
          ...
          name="manager"
          className="form-control"
          placeholder="manager de la empresa"
          value={form.manager}
          onChange={handleChange}
          autoComplete="address-level2"
          required
      ...
      <div className="mb-3">
        <label htmlFor="company-employees" className="form-label">
          Empleados
        </label>
        <input
          id="company-employess"
          type="number"
          name="employees"
          className="form-control"
